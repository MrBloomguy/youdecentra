            ...
            <div className="p-4 relative">
              ...
              <div className="w-20 h-20 bg-gray-300 dark:bg-gray-700 rounded-full absolute -top-10 border-4 border-reddit-light-brighter dark:border-reddit-dark-brighter flex items-center justify-center overflow-hidden">
                {profile?.details?.profile?.pfp ? (
                  <img src={profile.details.profile.pfp} alt={displayName} className="w-full h-full object-cover" />
                ) : (
              ...
              <div className="ml-24">
                ...
                {profile?.details?.profile?.description && (
                  <p className="text-sm mt-2">{profile.details.profile.description}</p>
                )}
            ...
            <TabsContent value="posts" className="mt-0">
              {isLoading ? (
                ...
                Array(3).fill(0).map((_, index) => (
                  <div key={index} className="post-card bg-reddit-light-brighter dark:bg-reddit-dark-brighter rounded-md border border-reddit-light-border dark:border-reddit-dark-border overflow-hidden p-4 mb-4">
